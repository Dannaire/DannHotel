...
import Modaluser from "@/components/modalupdateuser";
...
export default function User() {
  ...
  const updateUser = async (userId, newData) => {
    try {
      ...
      formData.append("nama_user", newData.nama_user);
  ...
  const handleAddSubmit = async (e) => {
    ...
    const formData = new FormData();
    formData.append("nama_user", e.target.elements.nama_user.value);
                            ...
                            <div className="inline-flex items-center gap-x-3">
                              ...
                              <div className="flex items-center gap-x-2">
                                <img
                                  ...
                                  src={
                                    "http://localhost:8080/gambar/" + user.foto
                                  }
                                  alt=""
                                />
                                <div>
                          ...
                          <td className="px-28 py-4 text-sm whitespace-nowrap">
                            <div className="flex items-center gap-x-12">
                              ...
                              <button
                                ...
                                onClick={() => handleModalToggle(user.id)}
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
